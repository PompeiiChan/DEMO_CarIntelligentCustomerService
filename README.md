...
面向车主或潜客的移动端对话界面，支持自然语言咨询、快捷问题、AI 回复、转人工提示和人工客服接入状态展示。

<img src="docs/images/client.png" alt="客户端聊天界面" width="340">

### 坐席端

面向人工客服的坐席工作台，集中展示待接手工单、对话历史、工单详情、AI 建议回复、Bad Case 标注和结束工单操作。

![坐席端工作台](docs/images/agent.png)

### 管理端

面向运营或知识库管理员的知识库管理页面，支持按分类查看文档、上传 Markdown、查看向量片段与 QA 条目数量，并确认文档入库状态。

![管理端知识库管理](docs/images/admin.png)
